...
;!function(){
    ...
    */
    ...
    //对象遍历
    lay.each = function(obj, fn,options){
        var key
            ,that = this;
    ...
    LAY.prototype.attr = function(key, value){
        ...
        }() : that.each(function(index, item,options){
            if(key !== "lay-key"){
                if(shuang){
                    if(value !== "date"){
    ...
    */
    ...
    Class.prototype.render = function(){
        ...
        lay(divFooter).html(function(){
            ...
            if(options.type === 'datetime'){
                html.push('<span lay-type="datetime" class="laydate-btns-time " id="time"  style="display: none">'+ lang.timeTips +'</span>');
                shuang = options.bian;
            }
        ...
        if(options.type === 'datetime'){
            ...
            shuang = true;
            document.getElementsByClassName('layui-laydate-main')[0].style.width = '100%';
            document.getElementsByClassName('layui-laydate')[0].style.width = '550px';
            document.getElementsByClassName('layui-laydate-list')[0].style.cssText = 'width: 50%;left:auto;right: 0;'
        }
    };
    ...
    Class.prototype.list = function(type, index){ 
        ...
        if(options.bian){
            elemCont.offsetParent.style.width = "550px";
        ...
        if(type === 'year' || type === 'month'){
            ...
            if(options.type!='datetime'){
                ...
                if(!shuang){ 
                    ...
                    // document.getElementsByClassName("laydate-btns-time")[0].innerHTML ="选择时间";
                }
            }
    ...
    Class.prototype.changeEvent = function(){
        ...
        if(options.bian){
            // debugger;
            that.tool(this, "datetime");
            // document.getElementsByClassName("laydate-btns-time")[0].innerHTML ="";
        }
    };
